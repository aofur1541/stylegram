...
<div id="body">
	<form:form action="modifyproduct.do" enctype="multipart/form-data" commandName="storeVO">
		...
		<ul>
			...
			<li>
				...
				<c:if test="${!empty storeVO.filename}">
				<br>
				<span>(${storeVO.filename})파일이 등록되어 있습니다.
			...
			<li>
				...
				<c:if test="${!empty storeVO.dfilename}">
				<br>
				<span>(${storeVO.dfilename})파일이 등록되어 있습니다.
				다시 업로드하면 기존 파일은 삭제됩니다.</span>
				</c:if>
			</li>
			<li>
			...
			<li>
				...
				<c:if test="${!empty storeVO.dfilename2}">
				<br>
				<span>(${storeVO.dfilename2})파일이 등록되어 있습니다.
				다시 업로드하면 기존 파일은 삭제됩니다.</span>
				</c:if>
			</li>
			<li>
			...
			<li>
				...
				<c:if test="${!empty storeVO.dfilename3}">
				<br>
				<span>(${storeVO.dfilename3})파일이 등록되어 있습니다.
				다시 업로드하면 기존 파일은 삭제됩니다.</span>
				</c:if>
			</li>
			<li>
